const useCasesTodo = {
    ...
    pushByOwner: [
        {
            rules: [
                "owner pode mandar push ou email pra usuário desde que esse usuário seja seu cliente",
            ],
        },
    ],
    ...
    order: [
        {
            ...
            useCases: [
                "owner marca comissão como paga comissionPaidByOwner e pedido orderPaidByClient",
                ...
                "retornar comissões de um determinado profissional num período de tempo calculando a soma de comissionValue e totalValue",
                "retornar total de um determinado salão podendo filtrar por profissional",
            ],
            rules: [
                "pra criar a comissão a data de inicio da request associada deve estar no passado",
            ],
        },
    ],
    fidelity: [
    ...
    ride: [
        {
            ...
            rules: [
                ...
                "status === 1 é quando saiu e ja esta a caminho, só pode ser 1 se o anterior for 0 e só pode ser disparado pelo driverUserType responsável",
            ...
            toDo: [
                ...
                "caso esse campo seja por tempo exigir pro salão preencher um campo costByTimeDriving o valor da taxa cobrada por tempo de viagem caso seja fixa um campo chamado fixedTax pra cobrar taxa fixa",
            ],
        },
    ],
};
