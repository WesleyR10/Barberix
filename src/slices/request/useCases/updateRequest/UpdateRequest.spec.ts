...
describe("UpdateRequest", () => {
    ...
    it("should return a request updated when updateRequestRepository insert it", async () => {
        const request = await testInstance(fakeQuery, fakeRequestEntity);
        expect(request).toEqual(fakeRequestEntity);
    });
    it("should return null a new request updated when updateRequestRepository return it", async () => {
