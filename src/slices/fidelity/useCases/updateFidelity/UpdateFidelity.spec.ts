...
describe("UpdateFidelity", () => {
    ...
    it("should return a fidelity updated when updateFidelityRepository insert it", async () => {
        const fidelity = await testInstance(fakeQuery, fakeFidelityEntity);
        expect(fidelity).toEqual(fakeFidelityEntity);
    });
    it("should return null a new fidelity updated when updateFidelityRepository return it", async () => {
