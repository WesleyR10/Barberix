...
describe("UpdateOrder", () => {
    ...
    it("should return a order updated when updateOrderRepository insert it", async () => {
        const order = await testInstance(fakeQuery, fakeOrderEntity);
        expect(order).toEqual(fakeOrderEntity);
    });
    it("should return null a new order updated when updateOrderRepository return it", async () => {
