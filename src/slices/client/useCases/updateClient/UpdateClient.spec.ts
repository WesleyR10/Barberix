...
describe("UpdateClient", () => {
    ...
    it("should return a client updated when updateClientRepository insert it", async () => {
        const client = await testInstance(fakeQuery, fakeClientEntity);
        expect(client).toEqual(fakeClientEntity);
    });
    it("should return null a new client updated when updateClientRepository return it", async () => {
