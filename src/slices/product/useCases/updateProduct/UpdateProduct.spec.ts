...
describe("UpdateProduct", () => {
    ...
    it("should return a product updated when updateProductRepository insert it", async () => {
        const product = await testInstance(fakeQuery, fakeProductEntity);
        expect(product).toEqual(fakeProductEntity);
    });
    it("should return null a new product updated when updateProductRepository return it", async () => {
