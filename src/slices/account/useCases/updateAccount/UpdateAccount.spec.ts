...
describe("UpdateAccount", () => {
    ...
    it("should return a account updated when updateAccountRepository insert it", async () => {
        const account = await testInstance(fakeQuery, fakeAccountEntity);
        expect(account).toEqual(fakeAccountEntity);
    });
    it("should return null a new account updated when updateAccountRepository return it", async () => {
