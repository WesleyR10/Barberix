...
describe("UpdateRecurrence", () => {
    ...
    it("should return a recurrence updated when updateRecurrenceRepository insert it", async () => {
        const recurrence = await testInstance(fakeQuery, fakeRecurrenceEntity);
        expect(recurrence).toEqual(fakeRecurrenceEntity);
    });
    it("should return null a new recurrence updated when updateRecurrenceRepository return it", async () => {
