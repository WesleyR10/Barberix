...
describe("UpdateUser", () => {
    ...
    it("should return a user updated when updateUserRepository insert it", async () => {
        const user = await testInstance(fakeQuery, fakeUserEntity);
        expect(user).toEqual(fakeUserEntity);
    });
    it("should return null a new user updated when updateUserRepository return it", async () => {
