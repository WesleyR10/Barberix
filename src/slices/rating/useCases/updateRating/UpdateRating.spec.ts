...
describe("UpdateRating", () => {
    ...
    it("should return a rating updated when updateRatingRepository insert it", async () => {
        const rating = await testInstance(fakeQuery, fakeRatingEntity);
        expect(rating).toEqual(fakeRatingEntity);
    });
    it("should return null a new rating updated when updateRatingRepository return it", async () => {
