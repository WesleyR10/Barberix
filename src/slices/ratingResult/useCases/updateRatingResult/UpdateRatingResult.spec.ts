...
describe("UpdateRatingResult", () => {
    ...
    it("should return a ratingResult updated when updateRatingResultRepository insert it", async () => {
        const ratingResult = await testInstance(fakeQuery, fakeRatingResultEntity);
        expect(ratingResult).toEqual(fakeRatingResultEntity);
    });
    it("should return null a new ratingResult updated when updateRatingResultRepository return it", async () => {
