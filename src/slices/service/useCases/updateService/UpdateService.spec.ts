...
describe("UpdateService", () => {
    ...
    it("should return a service updated when updateServiceRepository insert it", async () => {
        const service = await testInstance(fakeQuery, fakeServiceEntity);
        expect(service).toEqual(fakeServiceEntity);
    });
    it("should return null a new service updated when updateServiceRepository return it", async () => {
