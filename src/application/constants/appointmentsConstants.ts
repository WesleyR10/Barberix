...
export const ACCEPTABLE_DIFFERENCE_IN_MINUTES_TO_RATE = 5000; // 5000 minutes = 3 days
export const ACCEPTABLE_DIFFERENCE_IN_MINUTES_TO_CANCEL = -60; // Tempo mínimo para cancelar
export const ACCEPTABLE_DIFFERENCE_IN_MINUTES_TO_RESCHEDULE = -50; // Tempo mínimo para remarcar
